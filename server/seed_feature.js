    ...
    if (!existing) {
      await prisma.features.create({
        data: {
          ...
          description: 'Connect your own website to FlashBill. Receive online orders directly in your POS. Includes API access for menu sync, coupon validation, and order management.',
          is_free: false,
          monthly_price: 499,
          yearly_price: 4999
        }
